...
public class OngoingMatchServletCreate extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        PlayerDto firstPlayerDto = playerService.create(new PlayerCreate(firstPlayerName));
        PlayerDto secondPlayerDto = playerService.create(new PlayerCreate(secondPlayerName));
        OngoingMatch match = new OngoingMatch(firstPlayerName, firstPlayerDto.id(),
                secondPlayerName, secondPlayerDto.id());
